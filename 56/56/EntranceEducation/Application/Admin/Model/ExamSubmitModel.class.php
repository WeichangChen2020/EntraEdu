...
class ExamSubmitModel extends Model {
    ...
    public function getUnsubmitNum($college,$id) {
        ...
        // if (!is_null($college)) {
        //     $map['academy'] = $college;
        //     $sql = "SELECT  openId FROM hs_student_info, hs_student_list WHERE hs_student_list.number = hs_student_info.number AND hs_student_list.academy = $college AND openId NOT IN (SELECT openid FROM hs_exam_submit WHERE examid = $id)";
        //     $count = $Student->where($map)->count();
        // } else {
        //     $sql = "SELECT  openId FROM hs_student_info, hs_student_list WHERE hs_student_list.number = hs_student_info.number AND openId NOT IN (SELECT openid FROM hs_exam_submit WHERE examid = $id)";
        //     $count = $Student->count();
        // }



        // $sql = "SELECT COUNT(*) FROM hs_exam_submit WHERE examid = '$id' ";
