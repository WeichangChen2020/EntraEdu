...
<body>
<span>这里是<?php echo ($title); ?></span></br>
<span>你是<?php echo ($jiaose); ?></span></br>

<!-- test<audio src="/71/Public/audio/test.mp3" controls="controls"></audio> -->


<span>输入你的座位号（以开房者为1）</span></br>



<form method="post" action="<?php echo U('shenfen');?>">
	
	<input type="hidden" name="jiaose" value="<?php echo ($jiaose); ?>">
	<input type="hidden" name="Ejiaose" value="<?php echo ($Ejiaose); ?>">
	<input type="text" name="zuoweihao">
	<input type="hidden" name="flag" value="<?php echo ($flag); ?>">
	<input type="hidden" name="fangjianhao" value="<?php echo ($fangjianhao); ?>">

	<button type="submit">开杀</button>
</form>
