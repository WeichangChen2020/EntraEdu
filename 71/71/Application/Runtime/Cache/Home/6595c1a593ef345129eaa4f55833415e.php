...
<div class="content">
	<?php if(is_array($table)): $i = 0; $__LIST__ = $table;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tab): $mod = ($i % 2 );++$i; echo ($i); ?>.<?php echo ($tab["name"]); ?>(<?php echo ($tab["time"]); ?>)</br><?php echo ($tab["content"]); ?></br><?php echo ($tab["r1"]); ?></br>
	<a href="<?php echo U('replay',array('num'=>$i));?>" >回复</a></br></br><hr><?php endforeach; endif; else: echo "" ;endif; ?>
