...
class ExamSubmitModel extends Model {
    ...
    public function getUnsubmitNum($college,$id) {
        ...
        // if (!is_null($college)) {
        //     $map['academy'] = $college;
        //     $sql = "SELECT  openId FROM mg_student_info, mg_student_list WHERE mg_student_list.number = mg_student_info.number AND mg_student_list.academy = $college AND openId NOT IN (SELECT openid FROM mg_exam_submit WHERE examid = $id)";
        //     $count = $Student->where($map)->count();
        // } else {
        //     $sql = "SELECT  openId FROM mg_student_info, mg_student_list WHERE mg_student_list.number = mg_student_info.number AND openId NOT IN (SELECT openid FROM mg_exam_submit WHERE examid = $id)";
        //     $count = $Student->count();
        // }



        // $sql = "SELECT COUNT(*) FROM mg_exam_submit WHERE examid = '$id' ";
