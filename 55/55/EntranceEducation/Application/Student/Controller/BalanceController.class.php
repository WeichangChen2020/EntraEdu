...
class BalanceController extends Controller{
	...
	public function balance($openid = '') {
		...
		$url = array(
			'http://55.dataplatform.sinaapp.com/EntranceEducation/index.php/User/index/openId/'.$openid,

			'http://55.testtest11.sinaapp.com/EntranceEducation/index.php/User/index/openId/'.$openid,
